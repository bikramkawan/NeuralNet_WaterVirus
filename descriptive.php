...
<!-- js -->
 <script src="js/library/jquery.min.js"></script>
  ...
  <script src="js/library/math.js"></script>
    <script src="js/paper/descriptive.js"></script>
...
<!-- single -->
	...
	<div class="container">
		...
		<div class="grid_3 grid_5">
				...
				<div class="well">
									Choose Feature
									<select name="features" class="selectbox" id="descft" style="margin-right: 100px;">
...
?>
	...
	Sort By
				<select name="desc_mode" class="selectbox" id="mode" style="margin-right: 100px;">
				   			<option >Select Option</option>
					 <option value="Month" id="1">Month</option>
					 <option value="Year" id="2">Year</option>
					 <option value="Season" id="3">Season</option>
	...
	<!-- 	Second Block 	 -->
				...
				<br>	<center>
						<h1>
						<button id="calc_desc" class="label label-primary"> Descriptive Analysis</button>
...
<!-- End of Plots	 -->
			...
			<center>
						<h1>
						<button id="desresult" class="label label-primary">Display Result</button>
