...
%% Preparation for Neural Network Output JSON 
neuraloutputjson=[];
if(dividingmethod==1)

    for k=testInd(1):testInd(end-1)
        neuraloutputjson=[neuraloutputjson;neuraloutput(k,1) neuraloutput(k,2)];
    end
end

if(dividingmethod~=1)
    neuraloutputjson=[neuraloutputjson;neuraloutput((1:2000),:)]
...
savejson('neuralnetresult',jsondata,'neuralnetresult1.json');
